...
namespace WebApplicationWZH.Controllers
{
    ...
    public class TestController : Controller
    {
        ...
        public ActionResult getGoodDatalist(string pid,string openid,int nowPage = 1, int pageSize = 5)
        {
            ...
            for (int i = 1; i <= 22; i++)
            {
                ...
                {
                    openid = "aaa",
                     pid = 1, id=i,num =i ,tag="tag"+i,price = i,desc ="描述"+i,title= "title"+i,thumb= "/images/tabs/gd.png"
                     ,buytime = "2024.01.10",addtime="2024.02.28"
                });
            }
